    ...
    $.extend($.flexselect.prototype, {
        ...
        wire: function () {
            ...
            this.select.change(function () {
                ...
                //input.val(this.lastAbbreviation);
            });
        },

        filterResults: function () {
            ////console.log('filter reuslt:' + this.input.val());
            ...
            $.each(this.cache, function () {
                ...
                if (this.score > 0.0) {
                    ...
                    //this.score = LiquidMetal.score("0", abbreviation);
                    ////console.log('filterResults:' + this.text)
                    //results.push(this);
                }
            });
            ////console.log(results);
        ...
        pickSelected: function () {
            ...
            //console.log('pickSelected:' + this.input.val());
            ////console.log(selected);
            ////console.log(selected.disabled);
            if (selected == undefined) {
                //console.log('undefinedddd');
                ////console.log(this.input);
                //console.log('last:' + this.lastAbbreviation);
                //$('#listVersion_flexselect').val(this.lastAbbreviation);
                this.input.val(this.lastAbbreviation);
                this.select.val(0).change();
                //$('#listVersion_flexselect').text('texttt');
                //this.input.val(this.input.val());
                //this.input.text = "dsfsdf";
                ...
                //this.select.val(selected.value).change();
                //this.input.val('2222');
                //this.setValue('33333');
                this.picked = true;
            } else if (this.settings.allowMismatch) {
                //console.log('mismatch');
                this.setValue.val("3333");
            } else {
                //console.log('reset');
                //this.reset();
                //console.log(this.input);
